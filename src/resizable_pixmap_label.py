...
class QLabel_ResizablePixmap(QtGui.QLabel):
    def __init__(self, *args, **kwargs):
        super(QLabel_ResizablePixmap, self).__init__(*args, **kwargs)
    ...
    def _fitPixmap(self):
        if not self._pixmap.isNull():
            super(QLabel_ResizablePixmap, self).setPixmap(self._pixmap.scaled(self.size(),
